...
-- Banco de dados: `yeet`
--
CREATE DATABASE IF NOT EXISTS `yeet` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `yeet`;
...
--
ALTER TABLE `venda`
  MODIFY `id_venda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
