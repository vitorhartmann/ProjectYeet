...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/11/2018 às 19:20
...
(5, 'Bolacha Trakinas', 7, 00000000000001, '1.99', 5),
(6, 'Leite Tirol', 8, 00000000000002, '1.99', 6),
(7, 'Copo Americano', 17, 00000000000003, '5.99', 8),
(8, 'Arroz Do Tio', 20, 00000000000004, '1.59', 7);
...
--
ALTER TABLE `venda`
  MODIFY `id_venda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
